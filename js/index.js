document.addEventListener("DOMContentLoaded", () => {
    ...
    function createForm() {
        ...
        let fields = `
            <input type="text" id="name" name="name" placeholder="enter monster name">
            <input type="text" id="age" name="age" placeholder="enter monster age">
            <input type="text" id="description" name="description" placeholder="enter monster description">
